...
typedef enum GX_FEATURE_ID {
    ...
    9 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,     ///< 设备带宽限制模式，参考GX_DEVICE_LINK_THROUGHPUT_LIMIT_MODE_ENTRY
    ...
    1013 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Bayer格式,参考GX_PIXEL_COLOR_FILTER_ENTRY
    ...
    1018 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 测试图源选择，参考GX_TEST_PATTERN_GENERATOR_SELECTOR_ENTRY
    ...
    2003 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 永久IP方式配置IP
    ...
    3000 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 采集模式,参考GX_ACQUISITION_MODE_ENTRY
    ...
    3007 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 触发极性,参考GX_TRIGGER_ACTIVATION_ENTRY
    GX_ENUM_TRIGGER_SWITCH =
    3008 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 外触发开关,参考GX_TRIGGER_SWITCH_ENTRY
    ...
    3015 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 触发类型选择，参考GX_TRIGGER_SELECTOR_ENTRY
    GX_FLOAT_TRIGGER_DELAY = 3016 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 触发延迟
    GX_ENUM_TRANSFER_CONTROL_MODE =
    3017 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 传输控制模式，参考GX_TRANSFER_CONTROL_MODE_ENTRY
    GX_ENUM_TRANSFER_OPERATION_MODE =
    3018 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 传输操作模式，参考GX_TRANSFER_OPERATION_MODE_ENTRY
    ...
    3022 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 采集帧率调节模式，参考GX_ACQUISITION_FRAME_RATE_MODE_ENTRY
    ...
    3025 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,///< 模板噪声校正，参考GX_FIXED_PATTERN_NOISE_CORRECT_MODE


    //----------------DigitalIO Section----------------------------------
    GX_ENUM_USER_OUTPUT_SELECTOR =
    4000 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 用户自定义输出选择,参考GX_USER_OUTPUT_SELECTOR_ENTRY
    GX_BOOL_USER_OUTPUT_VALUE = 4001 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 用户自定义输出值
    GX_ENUM_USER_OUTPUT_MODE =
    4002 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 用户IO输出模式,参考GX_USER_OUTPUT_MODE_ENTRY
    ...
    5001 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 增益通道选择,参考GX_GAIN_SELECTOR_ENTRY
    GX_ENUM_BLACKLEVEL_AUTO =
    5003 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 自动黑电平,参考GX_BLACKLEVEL_AUTO_ENTRY
    GX_ENUM_BLACKLEVEL_SELECTOR =
    5004 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 黑电平通道选择,参考GX_BLACKLEVEL_SELECTOR_ENTRY
    GX_ENUM_BALANCE_WHITE_AUTO =
    5006 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 自动白平衡,参考GX_BALANCE_WHITE_AUTO_ENTRY
    GX_ENUM_BALANCE_RATIO_SELECTOR =
    5007 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 白平衡通道选择,参考GX_BALANCE_RATIO_SELECTOR_ENTRY
    ...
    5010 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 坏点校正,参考GX_DEAD_PIXEL_CORRECT_ENTRY
    ...
    6007 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 自动曝光、自动增益，光照环境类型,参考GX_AA_LIGHT_ENVIRMENT_ENTRY
    ...
    6020 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 图像亮度拉伸开关,参考GX_IMAGE_GRAY_RAISE_SWITCH_ENTRY
    GX_ENUM_AWB_LAMP_HOUSE =
    6021 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 自动白平衡光源,参考GX_AWB_LAMP_HOUSE_ENTRY
    ...
    7000 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 参数组选择,参考GX_USER_SET_SELECTOR_ENTRY
    ...
    7003 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 启动参数组,参考GX_USER_SET_DEFAULT_ENTRY
    ...
    8001 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 事件使能,参考GX_EVENT_NOTIFICATION_ENTRY
    ...
    8010 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 触发信号被屏蔽事件时间戳
    ...
    10002 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 帧信息项选择，参考GX_CHUNK_SELECTOR_ENTRY
    ...
    //////////////////////////////////////////////////////////////////////////
    GX_STRING_DEVICE_ID =
    4 | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 设备序列号[弃用，改用GX_STRING_DEVICE_SERIAL_NUMBER]
    ...
    5007 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 白平衡通道选择[弃用，改用GX_ENUM_BALANCE_RATIO_SELECTOR]
    GX_ENUM_AA_LIGHT_ENVIRMENT =
    6007 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 自动曝光、自动增益，光照环境类型[弃用，改用GX_ENUM_AA_LIGHT_ENVIRONMENT]
    ...
    GX_INT_ROI_HEIGHT =
    6011 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 自动调节感兴趣区域高度[弃用，改用GX_INT_AAROI_HEIGHT]
    GX_INT_AUTO_GAIN_VALUEMIN =
    6012 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 自动增益最小值[弃用，改用GX_FLOAT_AUTO_GAIN_MIN]
    GX_INT_AUTO_GAIN_VALUEMAX =
    6013 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 自动增益最大值[弃用，改用GX_FLOAT_AUTO_GAIN_MAX]
    GX_INT_AUTO_SHUTTER_VALUEMIN =
    6014 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 自动曝光最小值[弃用，改用GX_FLOAT_AUTO_EXPOSURE_TIME_MIN]
    GX_INT_AUTO_SHUTTER_VALUEMAX =
    6015 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 自动曝光最大值[弃用，改用GX_FLOAT_AUTO_EXPOSURE_TIME_MAX]
    GX_INT_CONTRASTPARAM =
    6017 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 对比度参数[弃用，改用GX_INT_CONTRAST_PARAM]
    ...
    6019 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 颜色校正系数[弃用，改用GX_INT_COLOR_CORRECTION_PARAM]
    GX_DS_INT_MAX_NUM_QUEUE_BUFFER = 18 | GX_FEATURE_INT |
...
*/
//----------------------------------------------------------------------------------
GX_API GXIsImplemented(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, _Bool *pbIsImplemented);
...
*/
//----------------------------------------------------------------------------------
GX_API GXIsReadable(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, _Bool *pbIsReadable);
...
*/
//----------------------------------------------------------------------------------
GX_API GXIsWritable(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, _Bool *pbIsWritable);
...
*/
//----------------------------------------------------------------------------------
GX_API GXGetBool(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, _Bool *pbValue);
...
*/
//----------------------------------------------------------------------------------
GX_API GXSetBool(GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, _Bool bValue);
...
*/
//----------------------------------------------------------------------------------
GX_API GXImportConfigFile(GX_DEV_HANDLE hDevice, const char *pszFilePath, _Bool bVerify);
